    ...
    return ListView(
      ...
      children: [
        ...
        Row(children: [
          ...
          const SizedBox(width: 8),
          Expanded(child: _TarjetaMetrica(titulo: 'Tráfico',  valor: '4.2 GB', icono: Icons.wifi,       color: cs.tertiaryContainer)),
        ]),
      ],
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (ctx, i) {
        ...
        return Card(
          color: esCritico ? cs.tertiaryContainer : cs.tertiaryContainer,
          child: ListTile(
            leading: Icon(
              esCritico ? Icons.error : Icons.warning,
              color: esCritico ? cs.tertiaryContainer : cs.onTertiaryContainer,
            ),
